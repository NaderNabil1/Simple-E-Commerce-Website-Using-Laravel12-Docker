...
@endsection
@section('breadcrumb_title', 'Add New Category')
                        ...
                        <form method="post" id="form" enctype="multipart/form-data">
                            ...
                            <div class="row gy-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name='name' class="form-control radius-8 @error('name') is-invalid @enderror" id="name" placeholder="Name" required>
