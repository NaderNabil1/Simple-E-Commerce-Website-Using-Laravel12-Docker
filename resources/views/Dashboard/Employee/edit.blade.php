...
@section('breadcrumbs')
<li>-</li>
<li class="fw-medium"><a href="{{ route('employees') }}" class="d-flex align-items-center gap-1 hover-text-primary">Employees</a></li>
@endsection
@section('breadcrumb_title', 'Edit Employee')
                        ...
                        <form method="post" id="form">
                            ...
                            <div class="row gy-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name='name' class="form-control radius-8 @error('name') is-invalid @enderror" id="name" placeholder="Name" value="{{ $employee->name }}">
                                    @error('name')<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>@enderror
                                </div>
                                <div class="col-sm-6">
                                    <label for="email" class="form-label fw-semibold text-primary-light text-md mb-8">Email</label>
                                    <input type="email" name='email' class="form-control radius-8 @error('email') is-invalid @enderror" id="email" placeholder="email" value="{{ $employee->email }}">
